...
| visual  | final pre-commit tree | `pnpm --filter @witchwatch/web test:e2e`                     |    0 | `docs/assets/workbench-overview.jpg`                                  | controlled examples visibly labeled invented                                                                           | desktop/mobile Chromium                                | 28 passed and 2 expected device-scope skips                                                                                 |
